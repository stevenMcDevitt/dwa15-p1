                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-100">
                            <ul class="nav navbar-nav">
                                <li><a href="index.php">P1 - Portfolio</a></li>
                                <li><a href="p2.php">P2 - TBD</a></li>
                                <li><a href="p3.php">P3 - TBD</a></li>
                                <li class=active><a href="p4.php">P4 - TBD</a></li>
                            </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <p><a href="http://www.google.com">Link to Project 4 Site</a></p>
                    <p><a href="http://www.google.com">Link to Project 4 Github Repository</a></p>
                    <p class="bottom-sep"></p>
                </div>
